...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    client.create(doc)
      .then(() => toast.success('Contact Information sent!'))
      .then(() => setFormData(initialState)).catch((err) => console.log(err));
  };
  return (
    <AnimatePage>
      <div className="flex flex-col md:flex-row px-8 justify-center pb-10 md:pb-6 lg:pb-0">
        <div className="hidden lg:flex flex-col items-center animate-slowfade gap-4 uppercase mr-16">
          <div className="relative flex items-center justify-center">
            <h2 className="text-5xl tracking-wider whitespace-nowrap text-gray-300 dark:text-gray-600 opacity-60">
              Contact Me
            </h2>
            <h2 className="absolute text-2xl font-semibold tracking-[.4em] whitespace-nowrap text-gray-800 dark:text-gray-200">
          ...
          <p className="w-3/4 text-center">Feel free to get in touch with me. I am always open to discussing new projects,
        ...
        <div className="w-full">
          ...
          <div className="lg:hidden relative flex flex-col items-center justify-center mb-6">
            ...
            <p className="w-full sm:w-3/4 text-center mt-2">Feel free to get in touch with me. I am always open to discussing new projects,
              creative ideas or opportunities to be part of your visions.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between mt-8">
            <form onSubmit={handleSubmit} className="flex flex-col justify-between w-full gap-6 md:gap-0">
              ...
              />
              <button
                className="flex justify-center items-center group fadeBtn hover:animate-makeItfadeIn p-3 border w-full dark:hover:bg-white dark:hover:text-black dark:hover:animate-none"
                type="submit"
              >
