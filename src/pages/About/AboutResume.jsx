...
const AboutResume = () => (
  <div className="animate-slideright flex flex-col md:flex-row mb-8 px-8 pb-10 md:pb-0" id="about">
    <div className="w-full">
      ...
      <div className="flex text-sm flex-col gap-4">
        ...
        <p className="w-full leading-6 animate-slideleft">Hello there! My name is
          <span className="font-semibold"> Kristian Fulkerson</span>.
        ...
        <div className="w-full flex gap-6 text-sm sm:text-lg">
          <div>
